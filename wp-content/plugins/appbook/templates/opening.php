...
<div class="alert alert-info">
	...
	<div>Sur cette page, vous avez les options pour définir les heures d’ouvertures journalières de votre entreprise.<br />Vous pouvez visualiser, ajouter, supprimer, éditer vos horaires d’ouvertures journalières.</div>
</div>
<?php endif; ?>
